	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">LEAF NOW Fam<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:LEAFNOW@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				LEAF NOW is a platform where you can buy/sell/donate plants and seeds.
				We provide your donated seeds and plants to the needy and also the farmers which will help them and reduce the expenses hence produce good quantity items
			</p>
